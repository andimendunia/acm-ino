...
if (velocity <= 0) { shoepairs=0; } else { shoepairs=shoedistance / velocity; }
    //====================================================================Serial.print(millis() / 5000); Serial.print(" ");
    Serial.print(rpm);
    Serial.print(" ");
    Serial.print(pulses);
    Serial.print(" ");
  ...
  if (millis() - senddata_py >= 5000) {
    ...
    senddata_py=millis(); } //====================================================================} void counter() { int
    pinB=digitalRead(encoderB); if (pinB==HIGH && millis() - lastDebounceTime[0]>= debounceDelay) {
    pulses++;
